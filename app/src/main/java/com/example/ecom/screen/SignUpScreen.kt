    ...
    Column (
        ...
        Button(
            onClick = {
                ...
                authViewModel.signup(email.value,password.value,name.value){ success, message->
                    if(success){
            ...
            Text(text = if(isloading.value)"Creating Account..." else "SignUp",fontSize = 20.sp, fontWeight = FontWeight.SemiBold)
        }
        ...
        TextButton(
            ...
            Text("Have an Account, SignUp",fontSize = 15.sp, fontWeight = FontWeight.SemiBold)
        }
